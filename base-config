...
static const int left_sidepad = 200;         /* left horizontal padding of bar */
static const int right_sidepad = 200;        /* right horizontal padding of bar */
#endif
...
/*static const char *dmenucmd[] = { "dmenu_run", "-fn", "Go Mono:size=10", "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, NULL };*/
